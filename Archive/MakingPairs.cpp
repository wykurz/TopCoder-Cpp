...
{
    {
        ...
        MakingPairs theObject;
        eq(0, theObject.get(card),3);
    }
    {
        int cardARRAY[] = {1,1,1};
        vector <int> card( cardARRAY, cardARRAY+ARRSIZE(cardARRAY) );
        MakingPairs theObject;
        eq(1, theObject.get(card),0);
    }
    {
        int cardARRAY[] = {5};
        vector <int> card( cardARRAY, cardARRAY+ARRSIZE(cardARRAY) );
        MakingPairs theObject;
        eq(2, theObject.get(card),2);
    }
    {
        int cardARRAY[] = {43,23,10,39,39,22,22,0,3,4,3,2};
        vector <int> card( cardARRAY, cardARRAY+ARRSIZE(cardARRAY) );
        MakingPairs theObject;
        eq(3, theObject.get(card),102);
    }
    {
        int cardARRAY[] = {0};
        vector <int> card( cardARRAY, cardARRAY+ARRSIZE(cardARRAY) );
        MakingPairs theObject;
        eq(4, theObject.get(card),0);
    }
    return 0;
}
// END CUT HERE
