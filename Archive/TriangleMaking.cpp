...
{
    {
        TriangleMaking theObject;
        eq(0, theObject.maxPerimeter(1, 2, 3),5);
    }
    {
        TriangleMaking theObject;
        eq(1, theObject.maxPerimeter(2, 2, 2),6);
    }
    {
        TriangleMaking theObject;
        eq(2, theObject.maxPerimeter(1, 100, 1),3);
    }
    {
        TriangleMaking theObject;
        eq(3, theObject.maxPerimeter(41, 64, 16),113);
    }
    return 0;
}
// END CUT HERE
