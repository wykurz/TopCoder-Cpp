...
{
    {
        UpDownNess theObject;
        eq(0, theObject.count(3, 1),2);
    }
    {
        UpDownNess theObject;
        eq(1, theObject.count(3, 0),4);
    }
    {
        UpDownNess theObject;
        eq(2, theObject.count(4, 3),4);
    }
    {
        UpDownNess theObject;
        eq(3, theObject.count(19, 19),24969216);
    }
    {
        UpDownNess theObject;
        eq(4, theObject.count(50, 2000),116596757);
    }
    {
        UpDownNess theObject;
        eq(4, theObject.count(50, 5000),116596757);
    }
    return 0;
}
// END CUT HERE
